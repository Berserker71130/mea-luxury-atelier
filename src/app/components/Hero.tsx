...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-luxury-bg flex items-center justify-center">
      ...
      {/* EXPLICIT HIGH-VISIBILITY SCROLL CUE */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-1 z-30 pointer-events-none sm:bottom-8">
        {/* Clear, high-contrast instruction */}
        <span className="text-[10px] tracking-[0.3em] text-amber-400 font-bold uppercase drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] animate-pulse">
          Scroll Down to Explore
        </span>

        {/* Distinct Chevron pointing the way */}
        <svg
          className="w-6 h-6 text-amber-400 drop-shadow-[0_2px_8px_rgba(212,175,55,0.4)] animate-[bounce_1.5s_infinite]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2.5}
